...
variable "github_repo" {
  ...
  type        = string
  default     = "charanreddy7cr7/charan-appu-invite"
}
...
#   Repo ID:   gh api /repos/charanreddy7cr7/charan-appu-invite --jq .id
...
data "aws_iam_policy_document" "github_actions" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:s3:::charan-appu-invite-tfstate",
      "arn:aws:s3:::charan-appu-invite-tfstate/*",
    ]
  }
  ...
  statement {
    ...
    resources = ["arn:aws:dynamodb:*:${data.aws_caller_identity.current.account_id}:table/charan-appu-invite-tf-lock"]
  }
